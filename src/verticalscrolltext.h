 ...
 */
#ifndef VERTICALSCROLLTEXT_H
#define VERTICALSCROLLTEXT_H
...
#include <QVector>
//滚动控件
class VerticalScrollText : public QWidget
{
    Q_OBJECT
public:

    explicit VerticalScrollText(QWidget *parent = 0);

    //设置范围
    void setRange(QVector<QString> &vTextstr);
    //获取当前值
    int readValue();
    QString getText();
    //设置当前值
